...
interface BonusPerkDistributorInterface extends ethers.utils.Interface {
  functions: {
...
export class BonusPerkDistributor extends BaseContract {
  ...
  interface: BonusPerkDistributorInterface;
