...
interface MysteryNftInterface extends ethers.utils.Interface {
  functions: {
...
export class MysteryNft extends BaseContract {
  ...
  callStatic: {
    ...
    mint(user: string, overrides?: CallOverrides): Promise<void>;
