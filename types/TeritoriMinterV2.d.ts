...
interface TeritoriMinterV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "setConfig((uint256,address,uint256,uint256,uint256,uint256,address,uint96))": FunctionFragment;
...
export class TeritoriMinterV2 extends BaseContract {
  ...
  interface: TeritoriMinterV2Interface;
